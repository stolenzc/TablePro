...
Each data type gets appropriate rendering:
...
1. Select the cells or rows to copy
2. Press `Cmd+C`
...
NULL values are visually distinct:
...
Alternating row colors make scanning easier:
